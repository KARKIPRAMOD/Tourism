      ...
      <div>
        ...
        >
          <div>
            ...
            tourist destination. The Board provides platform for vision-drawn
            leadership for Nepal’s tourism sector by integrating Government
            commitment with the dynamism of private sector.
          </div>
          <div>© 2025. Nepal Tourism Board. All rights reserved.</div>
        </div>
      </div>
      <div
        style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={{ color: "#0d70bd", cursor: "pointer" }}>
                Facebook
              </div>
            </div>
            <div
            ...
            >
              ...
              <div style={{ color: "#0d70bd", cursor: "pointer" }}>Twitter</div>
            </div>
          </div>
        </div>
        <div
