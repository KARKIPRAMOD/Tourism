      ...
      <div>
        <div>
          ...
          >
            ...
            <p class="text-danger">
              Total Price - <strong> Rs.12500/=</strong>
            </p>
        ...
        <div>
          ...
          >
            <h4>
              <a class="name">
                <strong>Ussangoda Night Camping</strong>
              </a>
            </h4>
            ...
            <p class="text-danger">
              Total Price - <strong> Rs.16500/=</strong>
            </p>
            <a href="/search/destination" class="btn btn-warning">
              GET MORE
            </a>
        ...
        <div>
          ...
          >
            <h4>
              <a class="name">
                <strong>Seegiri Travel PP2</strong>
              </a>
            </h4>
        ...
        <div class="card">
          ...
          >
            <h4>
              <a class="name">
                <strong>Goo GaLLe!!</strong>
              </a>
            </h4>
            Destination - Galle City,Galle port,Jungle
            Beach,Unawatuna,Ambalangoda <br></br>
            Number of days - 4 Days<br></br>
            Number of passengers - 5<br></br>
            <p class="text-danger">
              Total Price - <strong> Rs.23700/=</strong>
            </p>
            <a href="/search/destination" class="btn btn-warning">
              GET MORE
            </a>
          ...
          <div class="card">
            ...
            >
              <h4>
                <a class="name">
                  <strong>Polonnaru wandana</strong>
                </a>
              </h4>
              ...
              Number of passengers - 5<br></br>
              <p class="text-danger">
                Total Price - <strong> Rs.46700/=</strong>
              </p>
              <a href="/search/destination" class="btn btn-warning">
                GET MORE
              </a>
          ...
          <div class="card">
            ...
            >
              <h4>
                <a class="name">
                  <strong>Yala saffary FAM-7</strong>
                </a>
              </h4>
