    ...
    <div className="container">
      ...
      >
        ...
        <h1 class="header">
          <strong>
            <center>
              <div class="CuzUpText">Update customer's details</div>
            </center>
          </strong>
        </h1>
        <br></br>
      ...
      <img
        src={tour}
        style={{ position: "absolute", right: 170, top: 140 }}
        height={400}
        width={400}
        alt="Card image cap"
      ></img>
        ...
        <div className="form-row">
          ...
          <div className="form-group col-md-6">
            ...
            <input
              ...
              className="form-control"
              id="fande"
              placeholder="Enter new arriaval date"
              value={arriDate}
              onChange={(e) => {
        ...
        <div className="form-row">
          <div className="form-group col-md-6">
            ...
            <input
              ...
              className="form-control"
              id="rate"
              placeholder="Enter new pickup place"
              value={pickPlace}
              onChange={(e) => {
