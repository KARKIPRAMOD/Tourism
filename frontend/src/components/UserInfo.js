      ...
      <div className="container" class="p-3 mb-2 bg-white text-black">
        <div className="row">
          <div class="Headername">
            <h2>
              <center>
                <strong>Tourguide details</strong>
              </center>
            </h2>
          </div>
          <div class="ImageFile">
                  ...
                  <div class="card4 ">
                    <div class="SeeAllCuzPacks">
                      <li>
                        ...
                        <div class="siname">{tourguides.fullName}</div>{" "}
                      </li>
                      <li class="list-group-item">
                        <div class="si">Age</div>
                        <div class="userInputes">{tourguides.age}</div>
                      </li>
                      <li class="list-group-item">
                        <div class="si">Date of birth</div>
                        <div class="userInputes">{tourguides.dateOfBirth}</div>
                      </li>
                      <li class="list-group-item">
                        <div class="si">Contact Number</div>{" "}
                        <div class="userInputes">
                          {tourguides.contactNumber}
                        </div>
                      </li>
                      <li class="list-group-item">
                        <div class="si">Gender</div>
                        <div class="userInputes">{tourguides.gender}</div>
                      </li>
                      <li class="list-group-item">
                        <div class="si">E mail</div>
                        <div class="userInputes">{tourguides.eMail}</div>
                      </li>
                      <li class="list-group-item">
                        <div class="si">Work Experience</div>
                        <div class="userInputes">
                          {tourguides.workExperience}
                        </div>
                      </li>
                      <li class="list-group-item">
                        <div class="si">Amount</div>
                        <div class="userInputes">{tourguides.amount}</div>
                      </li>
