      ...
      <>
            ...
            {tourguides.map((tourguide, index) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  >
                    <span className="text-yellow-500 flex items-center mr-2">⭐</span>
        ...
        {showModal && selectedGuide && (
          <div style={styles.modalOverlay}>
            <div style={{ ...styles.modalContent, animation: "fadeInScale 0.4s ease-out" }}>
              ...
              <button
                onClick={() => this.handleReserve(selectedGuide.fullName, selectedGuide._id)}
